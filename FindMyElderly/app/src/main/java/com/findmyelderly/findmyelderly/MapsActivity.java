...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, DirectionFinderListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView temp123   = (TextView)findViewById(R.id.textView6);
        final TextView temp456   = (TextView)findViewById(R.id.textView7);
    ...
    private void sendRequest() {
        ...
        //destination =getCompleteAddressString(22.316402, 114.180341);
        //origin="香港公開大學";
        //destination="旺角站";
                try{
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        LatLng hcmus = new LatLng(22.316377, 114.180330);
